let buttonGithub = document.querySelector(".btn-theme-outline");
...
$(document).ready(function () {
  ...
  let sticky = {
    ...
    update: function () {
      ...
      let windowTop = Math.floor($(window).scrollTop());
      let $stickyLinks = self.$sticky.find('.navbar-nav .nav-item').removeClass('active');
      ...
      if ($(window).width() < 800 || $(window).height() < 500 || self.stickyTop > windowTop) {
        ...
        for (let i = self.offsets.length; i--;) {
